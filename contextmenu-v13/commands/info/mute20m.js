...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        let end = Date.now() + ms("20 minutes") 
        ...
        .setDescription(`${user} kullanıcısı metin kanallarında ${interaction.user} tarafından **20 dakika** boyunca susturulmuştur.\n\nMute Atılış Tarihi: \`${moment(Date.now()).format("LLL")}\`\nMute Bitiş Tarihi: \`${moment(Date.now() + ms("20m")).format("LLL")}\`\n Ceza Puanı \`(#${veri})\``)
