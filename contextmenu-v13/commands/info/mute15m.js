...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        let end = Date.now() + ms("15 minutes") 
        ...
        .setDescription(`${user} kullanıcısı metin kanallarında ${interaction.user} tarafından **15 dakika** boyunca susturulmuştur.\n\nMute Atılış Tarihi: \`${moment(Date.now()).format("LLL")}\`\nMute Bitiş Tarihi: \`${moment(Date.now() + ms("15m")).format("LLL")}\` \n Ceza Puanı \`(#${veri})\``)
